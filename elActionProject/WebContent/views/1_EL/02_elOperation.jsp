...
<body>
	...
	기존방식 (el 아님) : <%= (int)request.getAttribute("big") + (int)request.getAttribute("small") %>
	<br><br>
	...
	<!-- el 안에서 문자열 리터럴 제시 시 홑따옴표 쌍따옴표 가리지 않음 -->
	
	<h3>4. 객체가 null인지 또는 리스트가 비어있는지 비교</h3>
	pTwo가 null 입니까 : ${ pTwo == null } 또는 ${ empty pTwo } <br>
	pOne이 null 입니까 : ${ pOne == null } 또는 ${ empty pOne } <br>
	pOne이 null 아닙니가 : ${ pOne != null } 또는 ${ !empty pOne } 또는 ${ not empty pOne } <br>
	
	lOne이 비어있습니가 : ${ empty lOne } <br>
	lTwo가 비어있습니가 : ${ empty lTwo } <br><br>
	
	<h3>5. 논리 연산자</h3>
	${ true && true } 또는 ${ true and true } <br>
	${ true || false } 또는 ${ true or false } <br><br>
	
	big이 small 보다 크고 lOne이 비어있습니까 : ${ big gt small and empty lOne } <br>
